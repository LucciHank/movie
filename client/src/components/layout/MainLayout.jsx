      ...
      <Box sx={{ position: 'relative' }}>
        ...
        <DialogContent sx={{ p: 4, textAlign: 'center' }}>
          ...
          <Typography variant="body1" sx={{ fontStyle: 'italic', color: 'text.secondary', lineHeight: 1.6 }}>
            "Định mở web phim cho anh chị em cày dịp tết nhưng Hoàng Anh sợ bị bớ nên khả lăngggg là chỉ mở mấy hôm nghịch nghịch thôi =))) chúc cả nhà xem phim vui vẻ =))) web này hầu như phim rạp hay phim gì mới ra cũng có hết nhé!!!"
          </Typography>
        </DialogContent>
      </Box>
    </Dialog>
